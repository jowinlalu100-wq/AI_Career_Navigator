...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-ghost:hover { background: var(--indigo-dim); transform: translateY(-1px); }
    ...
    .phase-card:hover { border-color: var(--indigo-glow); }
    .phase-card::before {
      content: '';
      position: absolute;
      top: -60px; right: -60px;
    ...
    @media (max-width: 600px) { .steps::before { left: 19px; } }
    .step {
      display: flex;
      gap: 32px;
      padding: 36px 0;
    ...
    @media (max-width: 600px) { .step-num-wrap { width: 40px; height: 40px; font-size: 12px; } }
...
<section class="hero">
  ...
  <p class="hero-sub">Upload your resume. We extract your skills, match you to real careers, and surface live job openings — all in seconds.</p>
  <div class="hero-cta">
...
<section class="intro-text">
  <div class="container">
    ...
    <p class="large-copy reveal">
      AI Career Navigator reads your resume, identifies every skill and strength, and scores them against <span>hundreds of real career paths</span> — then connects you with live job openings that match who you already are.
    </p>
  </div>
</section>
    ...
    <div class="steps">
      <div class="step reveal">
        ...
        <div class="step-content">
          ...
          <p class="step-body">Drop in your PDF. Our parser reads what matters — experience, tools, projects, and soft skills — and discards the noise.</p>
        </div>
      </div>
      <div class="step reveal">
        ...
        <div class="step-content">
          ...
          <p class="step-body">Every technology, framework, and strength is extracted and tagged. No manual input required.</p>
      ...
      <div class="step reveal">
        ...
        <div class="step-content">
          ...
          <p class="step-body">Your skill profile is matched and scored against hundreds of career paths. You get a clear match percentage and a ranked shortlist — no guessing, no bias.</p>
        </div>
      </div>
      <div class="step reveal">
        ...
        <div class="step-content">
          ...
          <p class="step-body">Live job listings are fetched and filtered to your top career match. Apply directly, with confidence your profile already fits.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="phases">
  <div class="container">
    ...
    <p class="section-sub reveal">The platform is built to grow with you. Here's what's already here — and what's next.</p>

    <div class="phases-grid">
      <div class="phase-card reveal">
        <div class="phase-num">01</div>
        <h3 class="phase-title">Resume Intelligence & Career Matching</h3>
        <p class="phase-body">Upload any resume, get a full skill breakdown and a scored match list against real career paths. Live job results follow automatically from your top match.</p>
        <span class="phase-tag">LIVE NOW</span>
      </div>
      <div class="phase-card reveal">
        <div class="phase-num">02</div>
        <h3 class="phase-title">Gap Analysis & Learning Paths</h3>
        <p class="phase-body">See exactly which skills you're missing for your dream role — and get curated learning paths to close the gap, with progress tracking built in.</p>
        <span class="phase-tag">LIVE NOW</span>
      </div>
      <div class="phase-card reveal">
        ...
        <p class="phase-body"> Optimize your resume by mirroring exact keywords and specific tools 
            from the job description. Eliminate tables, graphics, and text boxes to ensure clean parsing, and track progress using a 100-point checklist.</p>
        <span class="phase-tag" style="color:var(--indigo-soft);background:var(--indigo-dim);border-color:var(--indigo-glow);">COMING SOON</span>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="faq-list">
      ...
      <div class="faq-item reveal">
        <button class="faq-q" aria-expanded="false">
          ...
          <span class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg></span>
        </button>
        <div class="faq-a"><p class="faq-a-inner">Our AI model is trained on thousands of real job descriptions and resume profiles. Match scores reflect genuine skill overlap — not keyword counting. Most users find their top three results closely match where they actually want to work.</p></div>
      </div>
      ...
      <div class="faq-item reveal">
        ...
        <div class="faq-a"><p class="faq-a-inner">Your resume is processed securely and used only to generate your skill profile. We do not sell or share your data with third parties. You can delete your data at any time from your account settings.</p></div>
      </div>
      ...
      <div class="faq-item reveal">
        ...
        <div class="faq-a"><p class="faq-a-inner">We currently support PDF resumes. Word (.docx) and plain text (.txt) support is coming in the next update. If your resume is in another format, exporting as PDF from any word processor takes under a minute.</p></div>
      </div>
      ...
      <div class="faq-item reveal">
        ...
        <div class="faq-a"><p class="faq-a-inner">Yes. Job results are fetched in real time from live boards each time you view them — not pulled from a static database. This means you see current openings, not listings that closed weeks ago.</p></div>
      </div>
      ...
      <div class="faq-item reveal">
        ...
        <div class="faq-a"><p class="faq-a-inner">Creating an account and running your first career match is completely free. Advanced features — like detailed gap analysis and learning paths — will be available as part of an upcoming premium plan.</p></div>
      </div>
